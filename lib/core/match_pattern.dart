    ...
    switch (tile.position.index) {
      case 0:
        if (tile.alchemyElement == AlchemyElement.materiaNulla) {
          matchesFoundMap.update(AlchemyElement.rebis, (value) => ++value,
              ifAbsent: () => 1);
          matchesFoundMap.update(AlchemyElement.caeleum, (value) => ++value,
              ifAbsent: () => 1);
          matchesFoundMap.update(AlchemyElement.quebrith, (value) => ++value,
              ifAbsent: () => 1);
        }
        break;
      case 1:
