    ...
    switch (tile.position.index) {
      case 0:
        if (tile.alchemyElement == AlchemyElement.materiaNulla) {
          matchesFoundMap[AlchemyElement.rebis] =
              matchesFoundMap[AlchemyElement.rebis]! + 1;
          matchesFoundMap[AlchemyElement.caeleum] =
              matchesFoundMap[AlchemyElement.caeleum]! + 1;
          matchesFoundMap[AlchemyElement.quebrith] =
              matchesFoundMap[AlchemyElement.quebrith]! + 1;
        }
        break;
      case 1:
